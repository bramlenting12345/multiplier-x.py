...
def loden_kettingen():                                                                # def loden kettingen 
...
if ontsnap_cel_item=="f":
   ...
   ontsnap_cel()                                                                    # def ontsnap cel 

else:
   loden_kettingen()                                                                # def loen kettingen 
   ontsnap_cel()                                                                    # def ontsnap cel 
...
if kies_item_1=="b" or kies_item_1=="e":
      if kies_item_2=="b" or kies_item_2=="e":
         ...
         loden_kettingen()                                                           # def loden kettingen 
         ontsnap_cel()                                                               # ontsnap uit cel 
...
if red_middel_1=="b" or red_middel_1=="e":
   if red_middel_2=="b" or red_middel_2=="e":
    ...
    loden_kettingen()                                                # def loden kettingen 
    ontsnap_cel()                                                    # def onstnspa uit cel 
